...
public class VideoOrchestrator
{
        ...
        [OrchestrationTrigger] TaskOrchestrationContext ctx)
    {
        ...
        var ttsResult = await ctx.CallActivityAsync<TtsActivityResult>(
            ...
            new TtsActivityInput(input.JobId, input.Fact)
            {
        ...
        var segments = await ctx.CallActivityAsync<List<VideoSegment>>(
            ...
            new PlanActivityInput(ttsResult.Words, ttsResult.TotalDuration, input.Fact));
        ...
        var clipTasks = segments.Select((seg, i) =>
            ctx.CallActivityAsync<FetchClipActivityResult>(
                ...
                new FetchClipActivityInput(
                    ...
                    VisionEndpoint:             input.VisionEndpoint,
        ...
        var clipSources = orderedResults.Select((r, i) =>
        {
            ...
            if (r.Attribution != null)
                return new ClipSource(r.Index, "YouTube CC", seg.SearchQuery, r.Attribution);
            else
                return new ClipSource(r.Index, "Pexels", seg.SearchQuery);
        }).ToList();
