...
public interface IContentFormatterService
{
    ...
    string FormatPostHtml(RawCarFactsContent content, SeoMetadata seo, List<UploadedMedia> media, string todayDate, List<BacklinkSuggestion>? backlinks = null, List<RelatedPostSuggestion>? relatedPosts = null);
